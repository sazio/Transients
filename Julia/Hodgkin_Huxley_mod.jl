...
V_th = -20        # mV , threshold potential for transmitter
S_max = 0.045     # maximal fraction of postsynaptically bound neurotransmitters
τ_syn = 0.1     # 100 μs, synaptic time scale
const κ = 0.5           # relative rate of transmitter binding and unbinding
V_rev = -80     # postsynaptic reversal potential (approx 0 mV)
